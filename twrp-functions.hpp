...
public:
	...
	static void Replace_Word_In_File(string file_path, string search, string word); // Replace word in file
	...
	static void Dumpb(bool do_unpack, bool is_boot);                                // Unpacking/repacking process for boot/recovery images
